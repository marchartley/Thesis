...
% \AltTextImageCancelled{item_content}{placeholder.pdf}{caption}{label}
\zzcommand{\AltTextImageCancelled}[4] {
  \begin{figure}
    \autofitgraphics[]{#2}
    \caption{#3}
    \label{#4}
...
% \AltTextImageTop{item_content}{placeholder.pdf}{caption}{label}
\zzcommand{\AltTextImageTop}[4] {
  \begin{figure}[H]
    \autofitgraphics[]{#2}
    \caption{#3}
    \label{#4}
...
% \AltTextImageBottom{item_content}{placeholder.pdf}{caption}{label}
\zzcommand{\AltTextImageBottom}[4] {
  #1
  \begin{figure}[H]
    \autofitgraphics[]{#2}
    \caption{#3}
