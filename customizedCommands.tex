...
% --- modified: \fitNimages now caches the row in \fitRowBox instead of printing it ---
...
\NewDocumentCommand{\autofitcaptions}{O{} m}{%
  ...
  \pgfkeys{/autofitcaptions, raise=0.2em, fontscale=1}%
  \ifblank{#1}{}{%
...
% \pretocmd{\equation}{\addcontentsline{equ}{myequations}{Equation~\theequation}}{}{}
% \pretocmd{\align}{\addcontentsline{equ}{myequations}{Equation~\theequation}}{}{}
\zzcommand{\eqlabel}[2]{
  \label{#1}%
  \addcontentsline{equ}{myequations}{\cref{#1}: #2}
}


% \let\cftmyequationstitlefont\cftloftitlefont
% \renewcommand{\cftmyequationstitlefont}{\normalfont}

% \let\cftmyequationsfont\cftfigurefont
% \let\cftmyequationspagefont\cftfigurepagefont
% \let\cftmyequationsleader\cftfigureleader
% \let\cftmyequationspresnum\cftfigurepresnum
% \let\cftmyequationsaftersnum\cftfigureaftersnum
