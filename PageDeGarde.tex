...
\begin{titlepage}
	...
	\tikz[remember picture,overlay] \node[opacity=1,inner sep=0pt] at (87.6mm, -134.25mm){\scalebox{1.2}{\includegraphics[]{images/PhD_Couverture_Fond.pdf}}};
	% \tikz[remember picture,overlay] \node[opacity=1,inner sep=0pt] at (73.6mm, -124.25mm){\includegraphics[width=\linewidth]{images/PhD_Couverture_Fond.pdf}};
	...
	{\fontfamily{phv}\fontseries{mc}\selectfont
		...
		\begin{tabularx}{\textwidth}{l l X r}
			...
			\textbf{Mme.~} & \textbf{CANI Marie-Paule} & Professeure des universités & Rapporteur \\
			...
			\textbf{M.~} & \textbf{MARI Jean-Luc} & Professeur des universités & Examinateur \\
			% \textbf{Prénom NOM} & [Titre] & [Rôle] \\
			\\
			\textbf{M.~} & \textbf{BARTHE Loïc} & Professeur des universités & Invité \\
			\textbf{Mme.~} & \textbf{GODARY Karen} & Maître de conférences & Invitée \\
			\\
			\textbf{M.~} & \textbf{FIORIO Christophe} & Professeur des universités & Directeur de thèse \\
			\textbf{Mme.~} & \textbf{FARAJ Noura} & Maître de conférences & Encadrante de thèse \\
		\end{tabularx} 
