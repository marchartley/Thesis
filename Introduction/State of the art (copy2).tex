...
\begin{itemize}
    ...
    \item Amplification methods, which is used to improve an existing synthetic terrain.
\end{itemize} 
...
% \subsubsection{Terrain features around coral islands}
