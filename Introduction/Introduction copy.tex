...
\AltTextImage{
    To accurately model robotic mission, robotics simulators (such as Gazebo and Isaac Sim) need the geometry of the terrain, fauna, and flora the robot might encounter. They also need material parameters to realistically simulate sensor behaviour and external forces acting on the robot.
