...
}{primitives_representation.png}{Primitives composition \cite{Genevaux2015}.}{fig:erosion-primitives-representation}{Primitives composition}
...
}{polypanatomy.jpg}{Anatomy of a single polyp, ranging in size from one to three millimeters in diameter.}{fig:into-polyp}{Anatomy of a single polyp}
