\graphicspath{ {./Chapter 2/figures/cGAN/} }
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.45 \linewidth]{erosionCellularHawick2014.png}
    \includegraphics[width = 0.45 \linewidth]{erosionHydraulicBenes2006.png}
    \includegraphics{erosionHydraulicSchott2023_2.png}
    \includegraphics{erosionRoudier1993.png}
    \caption{Four examples from \cite{Hawick2014}, \cite{Benes2006}, \cite{Schott2023} and \cite{Roudier1993a}.}
...
\begin{figure}[ht]
	\centering
	\includegraphics{sketchingGain2009.png}
    \includegraphics{sketchingTalgorn2018.png}
    \includegraphics{sketchingTasse2014.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width = \linewidth]{windByStrokes.pdf}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=1.0 \linewidth]{resistanceFunction.pdf}
	% \includegraphics[width=0.45 \linewidth]{schema_profile.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics{example_pix2pix_facade.png}
