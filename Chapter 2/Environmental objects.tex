...
}{FON-asymmetric-field-Peters2020.png}{A limitation of individual-based models is that the influence of each entity is often assumed to be isotropic, ignoring environmental factors.}{fig:env-obj-fon-asymmetric-scheme}
