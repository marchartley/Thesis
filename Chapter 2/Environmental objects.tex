...
From a large scale observation, where billions of individuals are indicernable from one another (like grass sproot, bacteria, whole population, ...), we consider the specie as a continuum and borrow diffusion-reaction models from physics and chemistry [CITE TURING PATTERN]. 
...
Diffusion-reaction equations for heat transfer in physics \\
...
\subsubsection{Advection (grid) model}
