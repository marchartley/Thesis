...
\teaser{
	...
	\caption{Our algorithm generate a dataset of pairs of labeled maps and height fields, which is used to train a conditional Generative Adversarial Network (cGAN). The user can intuitively create labeled maps with Paint and obtain a realistic 3D island with coral reefs.}
...
% This assumption reflects the typical formation of islands in archipelagos, where individual islands are geographically separate. It simplifies the generation of multi-island scenes by avoiding unnecessary inter-island interactions.
    ...
    % \AltTextImage{
        ...
        % {placeholder.pdf}{Typical profile of an island}{fig:coral-island-uniform-profile-assumption}
% Although real-world islands can have local variations in their profile, this uniformity makes the generation process more manageable and produces consistent terrain features.
    ...
    % \AltTextImage{
        ...
        % {placeholder.pdf}{Coral colonies mainly grow in shallow waters.}{fig:coral-island-constant-depth-assumption}
...
% \AltTextImageR{
    ...
    \end{Itemize}
% }{placeholder.pdf}{}{fig:coral-island-reef-profile}
...
We obtain the piecewise function as shown in \cref{fig:coral-island-reef-function}:
\begin{align}
...
% \end{align}
% A close approximation of $\max$ is achievable with $\frac{\smoothmax + \smoothmax^+}{2}$ (\cref{fig:coral-island-blend-function-island-with-upper}), but this function breaks at $a = b$. For this reason, we stick on the initial $\smoothmax$ function proposed.
...
%     \label{fig:coral-island-mode-collapse}
% \end{figure}
...
%     \label{fig:coral-island-data-generation-examples}
% \end{figure}
...
\begin{Itemize}
    \AltTextImage{
        ...
        {translation_example.png}{}{fig:coral-island-data-augmentation-translation}
    ...
    \AltTextImage{
        ...
        % {scaling_example.png}{}{fig:coral-island-data-augmentation-scaling}
    ...
    \AltTextImage{
        ...
        {copy_paste_example.png}{}{fig:coral-island-data-augmentation-copy-paste}
\end{Itemize}
...
\begin{Itemize}
    \AltTextImage{
        ...
        {placeholder.pdf}{}{fig:coral-island-labelled-image-texture}
    ...
    \AltTextImage{
        ...
        {placeholder.pdf}{}{fig:coral-island-labelled-image-materials}
\end{Itemize}
