...
\begin{figure}[H]
    ...
    \caption{A diagram showing the pipeline of the method [TODO]}
\end{figure}
...
\begin{Itemize}
    \AltTextImage{
        ...
        {placeholder.pdf}{Aerial view of an island.}{fig:coral-island_radial-symmetry-assumption}
...
% This assumption reflects the typical formation of islands in archipelagos, where individual islands are geographically separate. It simplifies the generation of multi-island scenes by avoiding unnecessary inter-island interactions.
        {placeholder.pdf}{Outlines deformations due to wind and waves}{fig:coral-island_wind-deformation-assumption}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 0.9 \linewidth]{placeholder.pdf}
    \caption{The user can interact directly on the island by editing (parallelly, in no specific order) (A) the top-view sketch, (B) the profile-view sketch, (C) and the wind velocity sketch.}
...
\begin{figure}[H]
    \includegraphics{placeholder.pdf}
    \caption{Blending two functions $f: \R \to \R$ (black) and $g: \R \to \R$ (blue) with the $\max$ operator (red), causing a discontinuity, and with the $\smoothmax$ operator (green), resolving the issue at the cost of slight overestimations on the function. }
...
\begin{Itemize}
    \AltTextImage{
        ...
        {placeholder.pdf}{}{fig:coral-island_data-augmentation-translation}

    \AltTextImage{
        \Item {Directional scaling:} By scaling the terrain in one direction, we create elongated islands that resemble corridors or archipelagos, adding another layer of diversity to the dataset.}
        {placeholder.pdf}{}{fig:coral-island_data-augmentation-scaling}
    ...
    \AltTextImage{
        ...
        {placeholder.pdf}{}{fig:coral-island_data-augmentation-copy-paste}
\end{Itemize}
...
\begin{figure}[H]
    \includegraphics[width=.3 \linewidth]{features_2.png}
    \includegraphics[width=.3 \linewidth]{heightmaps_2.png}
    \includegraphics[width=.3 \linewidth]{results_2.png}
    \includegraphics[width=.3 \linewidth]{features_1.png}
    \includegraphics[width=.3 \linewidth]{heightmaps_1.png}
    \includegraphics[width=.3 \linewidth]{results_1.png}
...
\end{figure}
\begin{figure}[H]
    \includegraphics[width=.3 \linewidth]{features_3.png}
    \includegraphics[width=.3 \linewidth]{heightmaps_3.png}
    \includegraphics[width=.3 \linewidth]{results_3.png}
    % \includegraphics[width=.3 \linewidth]{features_4.png}
    % \includegraphics[width=.3 \linewidth]{heightmaps_4.png}
    % \includegraphics[width=.3 \linewidth]{results_4.png}
...
The inference time for a single input image of dimension $256 \times 256$ is constant whatever the complexity of the scene. Using the NVIDIA GeForce GTX 1650 Ti GPU, the inference time measured is 5ms (std 1.1ms). 

\subsection{Validation}

\begin{figure}
    \includegraphics[width = 0.45\linewidth]{Mayotte-example.png}
    \includegraphics[width = 0.45\linewidth]{results_5.png}
    \caption{Comparison between of real (right) and synthetic (left) islands.}
\end{figure}
