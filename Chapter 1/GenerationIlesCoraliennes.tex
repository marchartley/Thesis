...
\begin{Itemize}
    ...
    {Kauai_island.png}{Aerial view of Kauai island, Hawaii.}{fig:coral-island-radial-symmetry-assumption}
...
}{sketching-Gasch2020.png}{\cite{Gasch2020} uses a top-view sketch to apply constains on the noise function modeling a terrain, creating an intuitive mean to create paths and roads. }{fig:coral-island-Gasch2020}
...
}{sketching-Natali-2012.png}{\cite{Natali2012} uses sketching to description of geologic phenomena. }{fig:coral-island-Natali2012}
...
\begin{Itemize}
    \AltTextImage{
        \Item{Translation:} Since the original algorithm always centers the island, we translate the islands within the image to remove this constraint (\cref{fig:coral-island-cGAN-examples}, leftmost). This ensures that the cGAN can generate islands in any position within the frame. By wrapping the island on the borders, the model learns that data can appear on the edges on the image. }
