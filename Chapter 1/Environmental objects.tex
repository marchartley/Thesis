...
\wrapFigR{./Figures/TopologicMaps/CliffErosionBidefordAndScalby.jpg}{0.4}{fig:semantic-representation_topo-coasts}{}%{Evolution of coastlines at Bideford, UK and Scalby, UK over the last 6000 years and 2000 years respectively (BP = Before Present) \cite{Shadrick2022}}

The use of parametric lines representing coasts of islands or continents is heavily used as it is easy to understand the concept of interaction using curves. It also shows an easy way to present the evolution of this interaction with respect to time, as the continuous change of shape can be interpreted by our mind as a moving line, providing a sense of velocity of change. 

While real coastlines are fractal, a representation using a continuous line is sufficient to be able to imagine the scene. A complex representation would be, on the other hand, difficult to read, without any significant improvement on the possibility to understand the reality, harder to draw and edit, and much more subject to change with time and become obsolete.

A simple element like a curve can however contain properties to provide more information which may or may not be displayed on the map. In this example, coastlines have information about the observation year.


\wrapFigL{./Figures/TopologicMaps/geologyMadagascar.jpeg}{0.4}{fig:semantic-representation_topo-madagascar}{Sedimentary distribution other Madagascar island \cite{Pratt2017}}
...
\wrapFigR{./Figures/TopologicMaps/QasrLibya.jpg}{0.3}{fig:semantic-representation_topo-karst}{Geological features distribution of karstic landscape at Qasr Lybia, Libya \cite{ElAmawy2009}}
...
\wrapFigL{./Figures/TopologicMaps/PerthCanyon.jpg}{0.4}{fig:semantic-representation_topo-canyon}{Localization of key parameters of Perth Submarine Canyon, Autralia \cite{Huang2014}}
