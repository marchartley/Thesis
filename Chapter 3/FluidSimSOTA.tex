...
\AltTextImage{
    ...
    \end{align}
}{delta-time-Lu2023.jpg}{Results of a fluid simulation after 5$\mu s$, 10$\mu s$ and 15$\mu s$ with different spatial resolutions (from left to right: 0.14mm, 0.07mm, 0.05mm and 0.04mm) shows large discrepancies. }{fig:erosion-sota-dt}
...
}{smoke-control-Tang2021.png}{An incompressible force field is computed to guide the smoke simulation from a user-defined shape to another \cite{Tang2021}.}{fig:erosion-artistic-fluid-Tang2021}
...
}{fluid-control-Lu2019.png}{\cite{Lu2019} uses fluid rigging-skinning on water particle to guide the animation of particles. }{fig:erosion-artistic-Lu2019}
