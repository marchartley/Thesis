...
\newcommand{\referenceExemple}[1] {\textit{Figure~\ref{tab:erosion_result_figures}: #1}}
...
In our method, the eroded quantity is approximated as the material contained in the half sphere, of radius $\particleSize$, in the normal opposite direction at the particle impact point (Figure~\ref{fig:erosion_erosion_heightfield}). We then use \eqref{eq:erosion_erosionRate}: 
...
\begin{figure*}
	...
	\caption{Erosion processes results on various representations presented in section \ref{sec:erosion_erosion_examples}. Used parameters used are detailed in  Table~\ref{tab:erosion_result_parameters}.}
