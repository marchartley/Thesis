...
\begin{Itemize}
    \Item{Detachment:} pieces of the ground of variable dimensions, ranging from complete ledges to grains of sand, are removed from the terrain depending on the simulated meteorological phenomenon, 
    \Item{Transport:} pieces of ground fallen from their initial position are moved to a different one such as a cornice falling down a slope or a grain of sand thrown into the air, 
    \Item{Deposition:} transported pieces of land are accumulated at a new part of the landscape. 
\end{Itemize}
