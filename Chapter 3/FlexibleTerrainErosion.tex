...
\teaser {
	...
	\caption[Shaded examples of eroded terrains using particle erosion]{Applying shading and textures on the generated geometry can produce a plausible aspect of a coast eroded by waves on a long timespan, or a desertic landscape eroded by wind, or a mountainous area flatten by thermal erosion.}
...
When provided with a hand-made or procedural velocity field, our particle system can reproduce simple river meanders (\cref{fig:erosion-results-meanders}). %(\referenceExemple{Meanders}). 
