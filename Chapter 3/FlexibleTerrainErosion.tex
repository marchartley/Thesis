...
}{erosion_deposition.pdf}{When a particle is in contact with the terrain surface, an amount $q_{\text{deposit}}$ of sediments contained in the particle is released in the ground, and $q_{\text{detachment}}$ is absorbed. }{fig:erosion-qdetachment-qdeposit}
...
\AltTextImage{
    The external forces $\extForce$ applied to a particle consist of gravity, buoyancy, and drag (\cref{fig:erosion-forces}). Gravity acts as
    \begin{align}
...
}{particle_force.pdf}{Particle's motion in a fluid consist of three forces: gravity, buoyancy, and drag. The later is acting opposite direction to the relative particle velocity in the fluid. }{fig:erosion-forces}
