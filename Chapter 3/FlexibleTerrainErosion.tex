\graphicspath{ {./Chapter 3/figures/}{./Chapter 3/figures/erosion/}{./Chapter 3/figures/terrain_representations/}{./Chapter 3/figures/fluids/}{./Chapter 3/results/}{./Chapter 3/otherPapersRepro/} {./Chapter 3/images/erosion_processes/}{./Chapter 3/images/real_world_compare/}}
...
Coastal & \addingFiguresToCell{Coastal_1.png}{Coastal_2.png}{Coastal_3.png}{} & \densityVox & 100x100x30 & 10 & 80 & 3 & 5 & 0.1 & 500 & 10.0 & 5.0 & 0.5 & Uniform & 0.5 & \cref{fig:erosion-results-coastal}
}
\newcommand{\exampleGlacier}{
Glacier & \addingFiguresToCell{Glacier1.png}{Glacier2.png}{Glacier3.png}{Glacier4.png} & \heightmap & 100x100 & 20 & 80 & 3 & 10 & 0.1 & 500 & 1.0 & 1.0 & 1.0 & None & 0.8 & TODO
}
\newcommand{\exampleLandslide}{
Landslide & \addingFiguresToCell{Glacier_2_1.png}{Glacier_2_2.png}{Glacier_2_3.png}{Glacier_2_4.png} & \heightmap & 100x100 & 20 & 200 & 10 & 2.5 & 0.2 & 500 & 0.1 & 1.0 & 1.0 & None & 4 & \cref{fig:erosion-results-landslides}
}
\newcommand{\exampleHydraulic}{
Rain & \addingFiguresToCell{Hydraulic1.png}{Hydraulic3.png}{Hydraulic5.png}{Hydraulic7.png} & \heightmap & 100x100 & 20 & 100 & 10 & 1.0 & 1.0 & 1000 & 10.0 & 2.5 & 0.3 & None & 4.0 & \cref{fig:erosion-results-rain}
}
\newcommand{\exampleKarstBinary}{
Karst & \addingFiguresToCell{KarstBinaryWithMarchingCubes1.png}{KarstBinaryWithMarchingCubes2.png}{KarstBinaryWithMarchingCubes3.png}{KarstBinaryWithMarchingCubes5.png} & \binaryVox & 100x100x50 & 2 & 1000 & 40 & 5 & 0.5 & 500 & 10.0 & 5.0 & 0.5 & Uniform & 20 & \cref{fig:erosion-results-karst}
}
\newcommand{\exampleKarstBinaryStrata}{
Karst & \addingFiguresToCell{KarstWithStrataNoise1.png}{KarstWithStrataNoise2.png}{KarstWithStrataNoise3.png}{KarstWithStrataNoise4.png} & \binaryVox & 100x100x50 & 2 & 80 & 3 & 10 & 0.1 & 500 & 10.0 & 5.0 & 1.0 & Uniform & 0.8 & TODO
}
\newcommand{\exampleLabyrinthOF}{
Glacier & \addingFiguresToCell{LabyrinthOpenFOAM1.png}{LabyrinthOpenFOAM2.png}{LabyrinthOpenFOAM3.png}{LabyrinthOpenFOAM4.png} & \densityVox & 100x100x40 & 2 & 80 & 3 & 10 & 0.1 & 500 & 1.0 & 1.0 & 1.0 & SIMPLE\cite{Caretto1973} & 0.8 & TODO
}
\newcommand{\examplePipes}{
Tunnel & \addingFiguresToCell{Pipes01.png}{Pipes05.png}{Pipes09.png}{Pipes11.png} & \densityVox & 100x100x50 & 1 & 100 & 100 & 2.5 & 0.1 & 500 & 1.0 & 1.0 & 1.0 & None & 0.8 & \cref{fig:erosion-results-tunnel}
}
\newcommand{\exampleRiver}{
River & \addingFiguresToCell{River1.png}{River2.png}{River3.png}{River4.png} & \heightmap & 100x100 & 5 & 100 & 50 & 1.5-5 & 0.5 & 900 & 0.1 & 1.0 & 1.0 & None & 2.5 & TODO
}
\newcommand{\exampleRiverTwo}{
River & \addingFiguresToCell{River_2_1.png}{River_2_2.png}{River_2_3.png}{River_2_4.png} & \layerMap & 100x100 & 5 & 100 & 50 & 1.5-5 & 0.5 & 900 & 0.1 & 1.0 & 1.0 & None & 2.5 & \cref{fig:erosion-results-river}
}
\newcommand{\exampleRiverWater}{
\makecell{River
(with water
level)} & \addingFiguresToCell{RiverWater1.png}{RiverWater2.png}{RiverWater3.png}{RiverWater4.png} & \heightmap & 100x100 & 5 & 100 & 50 & 1.5-5 & 0.5 & 900 & 0.1 & 1.0 & 1.0 & None & 2.5 & TODO
}
\newcommand{\exampleRiverObstacle}{
\makecell{River 
with obstacle} & \addingFiguresToCell{RiverWithObstacle1.png}{RiverWithObstacle2.png}{RiverWithObstacle4.png}{RiverWithObstacle6.png} & \heightmap & 100x100 & 5 & 100 & 50 & 1.5-5 & 0.5 & 900 & 0.1 & 1.0 & 1.0 & None & 2.5 & TODO
}
...
% }
\newcommand{\exampleWaterCurrents}{
Underwater & \addingFiguresToCell{WaterCurrent1.png}{WaterCurrent2.png}{WaterCurrent4.png}{WaterCurrent6.png} & \heightmap & 100x100 & 10 & 100 & 50 & 2.5 & 0.9 & 1000 & 1.0 & 1.0 & 1.0 & \cite{Stam2003a} & 4 & \cref{fig:erosion-results-underwater}
}
...
% }
\newcommand{\exampleWindErosion}{
Wind & \addingFiguresToCell{WindErosion1.png}{WindErosion2.png}{WindErosion4.png}{WindErosion5.png} & \densityVox & 100x100x50 & 0.2 & 100 & 10 & 1.5 & 0.9 & 1.5 & 1.0 & 1.0 & 1.0 & \cite{Paris2019b} & 0.5 & \cref{fig:erosion-results-wind}
}
\newcommand{\exampleVolcano}{
Volcano & \addingFiguresToCell{Volcano_2_1.png}{Volcano_2_2.png}{Volcano_2_3.png}{Volcano_2_4.png} & \densityVox & 100x100x40 & 50 & 150 & 30 & 1.0 & 5.0 & 2000 & 1.0 & 1.0 & 5.0 & None & 0.8 & \cref{fig:erosion-results-volcano}
}
\newcommand{\exampleMeanders}{
Meanders & \addingFiguresToCell{meanders_base.png}{meanders_fin.png}{}{} & \implicit & N/A & N/A & 10 & 20 & 5.0 & 1.0 & 1000 & 1.0 & 1.0 & 1.0 & $^{(1)}$ & 1 & \cref{fig:erosion-results-meanders}
}
...
\teaser {
	...
	\caption[Shaded examples of eroded terrains using particle erosion]{Applying shading and textures on the generated geometry produces a plausible aspect of a coast eroded by waves on a long timespan, or a desertic landscape eroded by wind, or a mountainous area flatten by thermal erosion.}
...
A standard approach for terrain modelling is to first generate a base terrain geometry and amplify it to improve realism. A base terrain geometry created solely using noise \cite{Musgrave1989, Olsen2004, Roudier1993} or our methods proposed in the previous chapters (\cref{chap:coral-island} and \cref{chap:semantic-representation}) will most likely lack details, and thus realism, and feel synthetic. To tackle this problem, erosion simulation algorithms are applied to simulate thousands of years of ageing by reproducing physical phenomena (i.e. effects of the rain, wind, and running water erosion agents) affecting the terrain making it more believable \cite{Stachniak2005, Smelik2009, Galin2019}.

The process of terrain alteration caused by the effect of water, air, or any other element, natural or not, over time is usually performed in three steps \cite{Neidhold2005}: 
\begin{Itemize}
...
A terrain is more than often represented in 2.5D using a 2D image called a heightmap whose greyscale values define terrain elevation. While being the major terrain representation, only a limited number of types of environments can be modelled. Indeed, natural landscapes are intrinsically 3D (overhangs, cavities or geological structures such as arches or goblins), this is particularly true for underwater environments generation. Alternate representations such as voxel grids, material layers or implicit surfaces can be used. A wide variety of methods have been proposed to simulate natural erosion phenomena on heightmaps as the partial differential equations to model erosion can be discretised and solved in 2D and the material detachment and deposition at a given point of the terrain surface can be easily performed by elevating or lowering the ground level i.e. changing locally pixel intensities.
...
We propose to tackle separately the material variation and the fluid simulation. Our method relies on a particle system to simulate eroding agents, each thrown particle collides with the terrain, performs terrain alteration at the collision point and transports material along its path.
Particle motion is computed using simple particle physics accounting for the medium density and particle properties (buoyancy and gravity forces). We consider each particle as independent, hence, they do not interact with each other, no collision detection or response. This simplification allows for efficient parallel computation.
...
% Density voxel grids are often used in high-fidelity simulations where detail and realism are essential. They are found in applications such as medical imaging, scientific visualisations, and advanced terrain modeling for films and visual effects. These grids are also employed in procedural terrain generation systems that require smooth and natural transitions between different terrain features, such as caves, cliffs, and eroded landscapes.
...
\begin{figure}
    ...
    \caption[Particle erosion's pipeline]{Our overall pipeline: our erosion process computes matter displacement of a terrain using an arbitrary representation as long as intersections between particles and the ground can be detected. An optional velocity ﬁeld, provided by the user, guides the particles trajectories. We propose surface alteration methods to apply the erosion to the terrain in a coherent way between possible representations. }
    \label{fig:erosion-pipeline-with-terrain}
\end{figure}

% \begin{figure}
%     \autofitgraphics{pipeline_with_terrain.pdf}
...
\zzcommand{\Terrain}{\mathcal{T}}
\zzcommand{\Particles}{{P}}
\zzcommand{\particle}{p}
\zzcommand{\normal}{\vec{n}}
\zzcommand{\Normal}{\vec{N}}
\begin{algorithm}[H]
    \caption{Particle-based erosion iterations.}
    \label{alg:erosion-main-loop}
    \DontPrintSemicolon
    \KwIn{Terrain $\Terrain$, particle parameters $(\particleSize, \particleDensity, COR, \maxCapacity, \erosionStrength, \depositionRate)$, medium params $(\fluidDensity,\viscosity)$, velocity field $\fluidVelocity$}
    \KwOut{Updated terrain $\Tilde{\Terrain}$}
    \BlankLine

    \For{$iter \gets 1$ \KwTo $N_{iters}$}{
        $Collisions \gets \emptyset$ \tcp*{Collisions list}
        \tcp{(1) Emit particles in domain}
        $\Particles \gets \text{SampleParticles}(\Terrain, params)$\;

        \tcp{(2) Particle transport}
        \ForEach{$\particle \in \Particles$}{
            \While{$p$ in terrain}{
                integrate motion \tcp*{\cref{eq:erosion-ode,eq:erosion-kinematics}}
                \If{$\particle$ intersects $\Terrain$}{
                    % $\normal \gets \Terrain.\Normal(\p)$\;
                    add collision data to $Collisions$ \tcp*{particle + terrain properties}\;
                    apply collision response \tcp*{\cref{alg:erosion-collision}}
                }
            }
        }
                
        \tcp{(3) Terrain updates}
        \ForEach{collision in $Collisions$} {
            % \tcp{\cref{alg:erosion-heightfield}, \cref{alg:erosion-sdf}, \cref{alg:erosion-voxels}, ...}
            accumulate terrain change $\Delta h, \Delta f, or \Delta \mu$ \tcp*{\cref{sec:erosion-application-on-representations}}
        }
        commit to $\Terrain$ and recompute normals\;

        % \tcp{(4) Optional: velocity repair}
        % apply \cref{alg:erosion-velocity-repair} if $\fluidVelocity$ static\;
    }
...
Particles are transported through the medium and may traverse several different media. Each medium is defined by a density and a flow. Consider, for example, water density to be \SI{1000}{\kilogram \per \cubic \meter} and that of air to be \SI{1}{\kilogram \per \cubic \meter}. The gravity applied to the particles is then very different between open and submerged environments due to the difference in buoyancy, while the process remains similar.
...
\AltTextImageR{
    Every time the particle hits the ground, a given amount $\erosionAmount$ of sediment is detached from the ground while another amount $\depositAmount$ of sediment is deposited at this location (respectively red and green arrows in \cref{fig:erosion-qdetachment-qdeposit}). Our erosion model is based on the work of \cite{Wojtan2007} where regular 3D grids are used to estimate the fluid velocity and sediment transport. In the spirit of \cite{Kristof2009}, we transposed their method into a particle-based erosion simulation, but in our proposition, we decouple the particle system from the fluid simulation, making the process more flexible and opening the door for richer effects that can easily be produced. 
}{erosion_deposition.pdf}{When a particle is in contact with the terrain surface, an amount $q_{\text{deposit}}$ of sediments contained in the particle is released in the ground, and $q_{\text{detachment}}$ is absorbed. }{fig:erosion-qdetachment-qdeposit}{On collision with the ground, some sediments in the particle are release while some are absorbed}
...
The shear rate $\shearRate$ is approximated by the relative velocity of the fluid to the solid boundary $\particleVelocity_{rel}$ over a short distance $l$.
We approximate the shear stress $\shearStress$ at the solid boundary by a power law:

\begin{align}
    \eqlabel{eq:erosion-shearStress}{Power-law shear stress (pseudoplastic model)}
    \shearStress = \shearStressConstant \shearRate^n,
\end{align}

where $\shearRate = \particleVelocity_{rel}/l$, $\shearStressConstant$ is the shear stress constant (often set to $1$), and $n \in [0,1]$ is the flow behaviour index. Shear-thinning models typically assume $n$ close to $\frac{1}{2}$ \cite{Wojtan2007}, which is why we used this value as a constant.  
...
\begin{align}
    \eqlabel{eq:erosion-erosionRate}{Erosion rate law}
...
\begin{align}
    \eqlabel{eq:erosion-erosionAmount}{Eroded volume per impact}
    \erosionAmount = \erosionRate \frac{ 2 \pi \particleSize^3 }{ 3 }.
\end{align}

The particle is also defined by a maximal amount of sediment that can be contained in its volume before being saturated, noted $\maxCapacity$. % Note that this constant will be used for the settling velocity computation \eqref{eq:erosion-initialSettlingVelocity}.
...
\begin{align} 
    \eqlabel{eq:erosion-initialSettlingVelocity}{Hindered Stokes settling velocity}
...
\begin{align}
    \eqlabel{eq:erosion-Richardson}{Richardson-Zaki hindered-settling factor}
...
\begin{align}
    \eqlabel{eq:erosion-deltaDepositon}{Deposited volume per contact}
...
\begin{align}
    \eqlabel{eq:erosion-bodyforce}{External forces on a particle}
...
\begin{align}
    \eqlabel{eq:erosion-drag}{Stokes drag on a sphere}
...
\AltTextImage{
    ...
    \begin{align}
        \eqlabel{eq:erosion-ode}{Particle equation of motion in a fluid}
        \dot{\particleVelocity} = \frac{\extForce + \dragForce}{\particleMass}.
    \end{align}
    
    The particle position $\p$ evolves as:
    \begin{align}
        \eqlabel{eq:erosion-kinematics}{Kinematic update for particle position}
        \dot{\p} = \particleVelocity.
    \end{align}
}{particle_force.pdf}{Particle's motion in a fluid consist of three forces: gravity, buoyancy, and drag. The later is acting opposite direction to the relative particle velocity in the fluid. }{fig:erosion-forces}{Forces applied to a particle in the equation of motion}
...
\begin{algorithm}[H]
    ...
    \DontPrintSemicolon
    \KwIn{Particle $(\p,\particleVelocity,\capacity)$, terrain $\Terrain$, restitution $COR$}
    \KwOut{Updated particle state $(\particleVelocity,\capacity)$}
    \BlankLine

    $\normal \gets \Terrain.\Normal(\p)$\;
    % $v_n \gets (\particleVelocity \cdot \normal)\normal$\;
    % $v_t \gets \particleVelocity - v_n$\;
    % $v'_n \gets -COR \cdot v_n$ \tcp*{Apply restitution on normal}
    % $\particleVelocity \gets v_t + v'_n$ \tcp*{Final velocity after collision}
    $\particleVelocity \gets COR \left(\particleVelocity - 2\,\dotProd{\particleVelocity}{\normal}\,\normal\right)$ \;

    \tcp{Update sediment capacity at this point}
    compute $\erosionAmount, \, \depositAmount$ \tcp*{\cref{eq:erosion-erosionAmount,eq:erosion-deltaDepositon}}
...
% The particle velocity $\particleVelocity$ can be integrated from \eqref{eq:erosion-gravity} by 

% \begin{align}
%     \label{eq:erosion-velocity-computation}
%     \particleVelocity = \int{ \frac{\extForce}{\particleMass} \, dt} + \settlingVelocity + \particleVelocity_0
% \end{align}
...
%     \extForce_{\text{body}} = \volume , (\particleDensity - \fluidDensity) , \gravity .
% \end{align}

% In addition, drag tends to relax the particle velocity $\particleVelocity$ toward the local fluid velocity $\fluidVelocity$. For small Reynolds numbers we use Stokes' drag law:
% \begin{align}
%     \label{eq:erosion-drag}
%     \dragForce = 6\pi \viscosity r ,(\fluidVelocity - \particleVelocity),
% \end{align}
% with $r$ the particle radius (i.e. half the particle size). For larger Reynolds numbers a more general drag coefficient $C_D$ can be used, e.g. Schiller-Naumann.

% The full equation of motion is therefore
% \begin{align}
%     \label{eq:erosion-ode}
%     \particleMass ,\dot{\particleVelocity}
%     = f(\capacity),\extForce_{\text{body}}
%     + \dragForce ,
% \end{align}
% where $f(\capacity)$ is a hindered-settling factor that reduces the effective body force as the particle's carried sediment approaches its maximum capacity. Following Richardson-Zaki \cite{Richardson1954}, we take
% \begin{align}
...
%     f(\capacity) = \left(1 - \frac{\capacity}{\maxCapacity}\right)^{n},
% \end{align}
% with exponent $n$ typically in the range $4$-$5.5$, and we set $n=5$ \cite{Wojtan2007}.

% Equation \eqref{eq:erosion-ode} naturally yields the classical Stokes settling velocity in quiescent fluid ($\fluidVelocity=0$), without requiring us to add a separate $\settlingVelocity$ term.
...
\begin{figure}
    ...
    \autofitcaptions[]{Height field, Layered model, Voxel grid, Implicit model}
...
\begin{align} 
    \eqlabel{eq:erosion-erosionHeightfield}{Height field update kernel}
...
% \begin{algorithm}[H]
%     \caption{Height-field terrain update.}
%     \label{alg:erosion-heightfield}
%     \DontPrintSemicolon
%     \KwIn{Heightmap $h(\p)$, contact point $\Center$, erosion radius $\particleSize$, volume change $\totalErosion$}
%     \KwOut{Updated heightmap $\Tilde{h}$}
%     \BlankLine

%     \ForEach{pixel $\p$ with $\|\p-\Center\| < \particleSize$}{
%         $d \gets \|\p - \Center\|$\;
%         $\Delta h(\p) \gets \frac{\totalErosion}{\frac{2}{3}\pi \particleSize^3}\,\sqrt{\particleSize^2 - d^2}$ \tcp*{\cref{eq:erosion-erosionHeightfield}}
%         $h(\p) \gets h(\p) + \Delta h(\p)$\;
%     }
%     \Return{$\Tilde{h}$}
% \end{algorithm}
...
\begin{align}
    \eqlabel{eq:erosion-erosionMetaball}{Linear metaball kernel}
...
The particle erosion applies at impact points at discrete positions, so we propose to add or subtract metaballs defined using \eqref{eq:erosion-erosionMetaball} to respectively deposit or erode material using a composition tree:
...
\begin{align}
    \eqlabel{eq:erosion-final-metaball}{SDF update via metaball composition}
...
% \begin{algorithm}[H]
%     \caption{Implicit terrain update via metaball composition.}
%     \label{alg:erosion-sdf}
%     \DontPrintSemicolon
%     \KwIn{Signed distance function $f(\p)$, contact point $\Center$, erosion radius $\particleSize$, volume change $\totalErosion$}
%     \KwOut{Updated SDF $\Tilde{f}(\p)$}
%     \BlankLine

%     $d = \|\p - \Center\|$\;
%     \tcp{Metaball primitive at collision}
%     $metaball(\p) \gets -\frac{3\totalErosion}{\pi \particleSize^3}\,\frac{(1-d)}{\particleSize}$, $metaball(\p)=0$ if $d>\particleSize$ \tcp*{\cref{eq:erosion-erosionMetaball}}

%     \tcp{Boolean composition}
%     $\Tilde{f}(\p) \gets g\left(f(\p),metaball(\p)\right)$ \tcp*{smooth union or subtraction}
%     \Return{$\Tilde{f}$}
% \end{algorithm}


\subsubsection{Other function-based terrains}
\label{sec:erosion-application_on_other_implicit}
Other function-based terrain models are present in the literature, notably a 2.5D representation based on the surface gradient \cite{Guerin2022} and a 3D representation based on curves \cite{Becher2017}, for which the trajectory of each particle projected to the closest surface could be used to define the alteration of the terrain.
...
\begin{align}
    \eqlabel{eq:erosion-erosion-gradients}{Gradient-based terrain update kernel (with discontinuity)}
...
Avoiding the singularity for $\particleSize = d$ can be done using a regularisation by introducing $\eps \ll \particleSize$ in \cref{eq:erosion-erosion-gradients}:

\begin{align}
    \eqlabel{eq:erosion-erosion-gradients-corrected}{Gradient-based terrain update kernel (no discontinuity)}
...
We apply the erosion from a particle at position $\Center$ on all points $\p$ in the volume, proportionally to the distance from the centre of the sphere $d = ||\p - \Center||$, to find an approximation to the real erosion value per voxel $\totalErosion_{approx} = \totalErosion \frac{1 - d}{\particleSize}$.  
...
\begin{align}
    \eqlabel{eq:erosion-erosionVoxels}{Density-voxel grid update kernel}
...
\begin{algorithm}[H]
    ...
    \DontPrintSemicolon
    \KwIn{Voxel grid $f:\Z^3 \to [-1,1]$, contact point $\Center$, erosion radius $\particleSize$, volume change $\totalErosion$}
    \KwOut{Updated grid $\Tilde{f}$}
    \BlankLine

    $\text{total} \gets \sum_{\q \in \|\q - \Center\| < \particleSize}(1-\tfrac{\|\q-\Center\|}{\particleSize})$\;
    \ForEach{voxel $\p$ with $\|\p-\Center\| < \particleSize$}{
        $d \gets \|\p - \Center\|$\;
        $\Delta f(\p) \gets \totalErosion \cdot \dfrac{(1-\tfrac{d}{\particleSize})}{\text{total}}$ \tcp*{\cref{eq:erosion-erosionVoxels}}
        $f(\p) \gets f(\p) + \Delta f(\p)$\;
        \If{$f(\p) > 1$}{spill excess upward voxel}
    }
    \Return{$\Tilde{f}$}
\end{algorithm}
...
\begin{align}
    \eqlabel{eq:erosion-erosionDiscreteVoxels}{Binary-voxel grid update kernel}
...
% The effect of each parameter is shown individually in \cref{fig:erosion-analysis-wind-density,fig:erosion-analysis-radius,fig:erosion-analysis-cor-gravity,fig:erosion-analysis-critical-shear-power}. 

The influence of each parameter on the erosion process is illustrated in \cref{fig:erosion-analysis-wind-density,fig:erosion-analysis-radius,fig:erosion-analysis-cor-gravity,fig:erosion-analysis-critical-shear-power,fig:erosion-analysis-deposition-erosion}. In \cref{fig:erosion-analysis-wind-density}, particle density controls the particle inertia and thus its sensitivity to the velocity field. Low-density particles follow the wind closely, generating fine and widely distributed erosion, whereas high-density particles travel straighter and carve deeper, more localised channels. In \cref{fig:erosion-analysis-radius}, increasing the particle radius produces smoother erosion and deposition patterns because larger particles average the terrain gradients over a wider area. \cref{fig:erosion-analysis-cor-gravity} highlights the combined effect of gravity and the coefficient of restitution: low values of COR cause particles to lose energy rapidly and accumulate at the base of slopes, emulating scree or debris deposits, while higher COR values allow particles to travel farther and mimic viscous, fluid-like transport. The influence of critical shear and shear power parameters is shown in \cref{fig:erosion-analysis-critical-shear-power}; larger critical shear thresholds limit erosion to steep regions, whereas higher shear power amplifies the rate of material removal over the entire terrain. Finally, in \cref{fig:erosion-analysis-deposition-erosion}, the erosion and deposition factors directly control the global mass transfer. High erosion rates deepen valleys and accentuate roughness, while high deposition rates quickly smooth the terrain and fill cavities. Together, these examples demonstrate that the proposed model can reproduce a continuum of erosion behaviours ranging from diffusive smoothing to strongly channelised material transport.

 Parameters used for each result are available in \cref{tab:erosion-result_parameters}. 
...
The environment density $\fluidDensity$ is set to \SI{1}{\kilogram\per\cubic\meter} above the water level (blue regions of the terrain) and \SI{1000}{\kilogram\per\cubic\meter} below it. The velocity field is refined using the diffusion strategy described previously.


\begin{figure}
    \autofitgraphics[]{analysis-density-wind-X.pdf}
    \caption[Particle density and wind field]{Uniform wind field applied laterally on a terrain with different particle densities. Deposition and erosion are visible in red and blue respectively. }
    \label{fig:erosion-analysis-wind-density}
\end{figure}

\begin{figure}
    \autofitgraphics[]{analysis-radius.pdf}
    \caption[Particle radius influence]{Particle radius influence the smoothness over the final result. Red and blue indicate deposition and erosion, respectively. }
    \label{fig:erosion-analysis-radius}
\end{figure}

\begin{figure}
    \autofitgraphics[]{analysis-cor-gravity.pdf}
...
\begin{figure}
    \autofitgraphics[]{analysis-critical-shear-power.pdf}
    \caption[Critical shear value and shear power value influences]{Large critical shear values restrict erosion to steep slopes, while large shear power values increase the effect of erosion on the whole terrain. Red and blue indicate deposition and erosion, respectively. }
    \label{fig:erosion-analysis-critical-shear-power}
\end{figure}

\begin{figure}
    \autofitgraphics[]{analysis-deposition-erosion.pdf}
    \caption[Erosion and deposition rates influences]{Erosion and deposition rates directly influence the displacement of matter from the particles on the terrain. Red and blue indicate deposition and erosion, respectively. }
...
\begin{figure}[H]
    \autofitgraphics[]{results_rain-2.pdf}
...
We demonstrate the result of rain erosion in \cref{fig:erosion-results-rain} with a computation time of 4 seconds.%\referenceExemple{Rain} with a computation time of 4 seconds.  
...
\begin{figure}[H]
    \autofitgraphics[]{results_coastal-2.pdf}
...
This effect can only be simulated on 3D terrain representations since it would create cliffs on a 2D representation.  
% \referenceExemple{Coastal} 
...
\begin{figure}[H]
    \autofitgraphics[]{results_meanders-2.pdf}
...
When provided with a hand-made or procedural velocity field, our particle system reproduces simple river meanders (\cref{fig:erosion-results-meanders}). %(\referenceExemple{Meanders}). 
...
\begin{figure}[H]
    \autofitgraphics[]{results_river-2.pdf}
...
\begin{figure}[H]
    \autofitgraphics[]{results_landslides-2.pdf}
...
\begin{figure}[H]
    \autofitgraphics[]{results_karsts-2.pdf}
...
\begin{figure}[H]
    \autofitgraphics[]{results_wind-2.pdf}
...
\begin{figure}[H]
    \autofitgraphics[]{results_underwater-2.pdf}
...
\begin{landscape}
    % \centering
    \begin{table}
        \begin{tabularx}{\linewidth}{|X|Hl|l|l|l|l|l|l|l|l|l|l|l|l|l|}
            \hline
            \thead{Name} & \thead{Results} & \thead{Rep.} & \thead{Dimensions} & \thead{Res} & \thead{$\#P$} & \thead{$\#N$} & \thead{$\particleSize$} & \thead{$COR$} & \thead{$\particleDensity$} & \thead{$\capacityFactor$} & \thead{$\erosionRate$} & \thead{$\depositionRate$} & \thead{Vel field} & \thead{$t$} & Figure \\
            \hline
            \exampleHydraulic \\
            \exampleCoastal \\
            \exampleMeanders \\
...
\citeName{Paris2019b} \cite{Paris2019b} simulate the effect of wind over sand fields defined on stacked materials, creating dune structures, even taking into account obstacles alike \citeName{Roa2004} \cite{Roa2004} and different material layers such as vegetation \cite{Cordonnier2017a}, which are not affected by abrasion. A wind field simulation is required to produce results, and while \citeName{Roa2004} and \citeName{Onoue2000} \cite{Onoue2000} consider a uniform vector field, this work considers a dynamic vector multi-scaled warped field derived from terrain height. The sand grains then apply multiple moves: sand lift, bounces, reptation and avalanching. Once the sand is lifted by the wind, the trajectory of the grains can be seen as the displacement of particles, fitting completely with our model, as illustrated in \cref{fig:erosion-screen-paris2020}.

\begin{figure}[H]
    \autofitgraphics{desert.pdf}
    \caption[Comparison of desertscape erosion with \cite{Paris2019b}]{The algorithm from \citeName{Paris2019b} allows for the generation of desertscapes (top), which we can (at least partially) reproduce with our erosion simulation (bottom). The different effects are achieved by altering the wind direction and strength. Top results are obtained using distributed code from the authors \cite{Paris2019b}.}
...
% \begin{figure}
%     \autofitgraphics[]{island-0.png,island-1.png,island-2.png,island-10.png}
%     \caption{}
%     \label{fig:erosion-island-reef}
% \end{figure}
...
% This work is a generalisation of erosion that is applicable to any terrain representation. 
...
Note that not all effects can be applied to all representations due to their 3D nature. For instance, karst generation, an intrinsically volumetric structure, is not applicable on 2.5D data structures.

\paragraph{Realism.}
The realism of the erosion simulation is highly correlated to the size and quantity of particles used and their distribution. Using too few or distributing them too sparsely results in a terrain that is unrealistic, since the alteration will have localised effects, breaking process homogeneity.
...
While we can replicate various effects, the "fan" shape commonly observed in natural erosion patterns is not perfectly represented. This limitation arises because we do not account for the splitting of a particle, a process that significantly influences the multidirectional dislocation and trajectory of individual particles \cite{Ranz1960}. Additionally, we acknowledge an issue where particles may collide with the ceiling and the deposition becomes stuck. While a potential resolution involves splitting particles upon impact rather than simply depositing sediment, this introduces complexities to the parallelisation layer of the method. Allowing particles to split introduces unpredictability in the total number of particles that will exist in the simulation. This unpredictability complicates the use of multi-threading. Future work includes finding a data structure allowing this splitting efficiently, leading to more realistic erosion patterns.
...
% \begin{Itemize}
%     \Item{} mass-conserving settings yield plausible transport-deposition patterns on both surfaces and volumes,
%     \Item{} coefficient of restitution and capacity act as effective, interpretable knobs for shaping talus angles and smoothing,
%     \Item{} underwater scenarios fall out naturally from the same equations by changing fluid density/viscosity.
% \end{Itemize}
